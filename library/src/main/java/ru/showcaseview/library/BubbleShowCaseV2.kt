...
class BubbleShowCaseV2(builder: BubbleShowCaseBuilderV2) {
    ...
    private val mBubbleShowCaseListener: BubbleShowCaseListenerV2? = builder.mBubbleShowCaseListener
        ...
        return BubbleMessageViewV2.Builder()
            ...
            .listener(object : OnBubbleMessageViewListener {
                override fun onBubbleClick() {
                    mBubbleShowCaseListener?.onBubbleClick(this@BubbleShowCaseV2)
                }
    ...
    private fun addBubbleMessageViewDependingOnTargetView(
        targetView: View?,
        bubbleMessageViewBuilder: BubbleMessageViewV2.Builder,
        backgroundDimLayout: RelativeLayout?
    ) {
        Log.e("TAG", targetView.toString())
        if (targetView == null) return
        val showCaseParams = RelativeLayout.LayoutParams(
            RelativeLayout.LayoutParams.MATCH_PARENT,
            RelativeLayout.LayoutParams.WRAP_CONTENT
        )
        Log.e("TAG", bubbleMessageViewBuilder.mArrowPosition[0].toString())
